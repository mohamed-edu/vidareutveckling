...
namespace VarmDrinkStation
{
    ...
    internal class CoffeeFactory : IWarmDrinkFactory
    {
        public IWarmDrink Prepare(int total)
        {
            Console.WriteLine($"Pour {total} ml of hot coffee in your cup"); // Utskrift av mängden kaffe som hälls upp
    ...
    internal class CappuccinoFactory : IWarmDrinkFactory
    {
        public IWarmDrink Prepare(int total)
        {
            Console.WriteLine($"Pour {total} ml of hot cappuccino in your cup"); // Utskrift av mängden cappuccino som hälls upp
    ...
    internal class HotChocolateFactory : IWarmDrinkFactory
    {
        public IWarmDrink Prepare(int total)
        {
            Console.WriteLine($"Pour {total} ml of hot chocolate in your cup"); // Utskrift av mängden choklad som hälls upp
    ...
    public class WarmDrinkMachine
    {
        ...
        public WarmDrinkMachine()
        {
            ...
            // Registrerar fabriker för olika drycker
